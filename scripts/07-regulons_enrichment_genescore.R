...
out<-here("../methyl/outputs/07-regulons_enrichment_genescore")
dir.create(out)
...
saveRDS(res_gsea_cl,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_clusterprofiler.rds")
fwrite(res_gsea_cl_dt,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_clusterprofiler.csv")
...
saveRDS(res_gsea_cl2,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_non_extended_clusterprofiler.rds")
fwrite(res_gsea_cl2_dt,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_non_extended_clusterprofiler.csv")
...
res_gsea_cl3<-GSEA(geneList = genes_rank,TERM2GENE =data.frame(regulons_df[str_detect(term,"e$")]) ,
                   scoreType="pos",
                   minGSSize = 10,maxGSSize = 500,eps=0)
res_gsea_cl3_dt<-data.table(as.data.frame(res_gsea_cl3))

saveRDS(res_gsea_cl3,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_extended_clusterprofiler.rds")
fwrite(res_gsea_cl3_dt,"outputs/07-regulons_enrichment_genescore/res_gsea_genescore_regulon_extended_clusterprofiler.csv")

res_gsea_cl3_dt[p.adjust<0.1]
res_gsea_cl3_dt[ID=="EGR1e"]
head(res_gsea_cl3_dt[order(p.adjust)]$ID,100) #
res_gsea_cl3<-pairwise_termsim(res_gsea_cl3,showCategory = 88)

emapplot(res_gsea_cl3,showCategory = 88,min_edge=0.2)
